% Unofficial Universitat de Barcelona Poster Template
% https://github.com/mjosephol/gemini-cam
...
\addtobeamertemplate{headline}{}
{
    \begin{tikzpicture}[remember picture,overlay]
      ...
      {\includegraphics[height=4.5cm]{logos/Logo_Universitat_de_Barcelona}}; 
    \end{tikzpicture}
}
